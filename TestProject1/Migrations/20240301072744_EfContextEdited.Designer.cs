...
namespace TestProject1.Migrations
{
    ...
    [Migration("20240301072744_EfContextEdited")]
    partial class EfContextEdited
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TestProject1.EfContext.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            InternationalName = "IT Department",
                            Name = "IT отдел"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("TestProject1.EfContext.Manager", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TestProject1.EfContext.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TestProject1.EfContext.Sale", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TestProject1.EfContext.Manager", b =>
                {
                    b.HasOne("TestProject1.EfContext.Manager", "Chief")
                        .WithMany("Subordinates")
                        .HasForeignKey("IdChief");

                    b.HasOne("TestProject1.EfContext.Department", "MainDepartment")
                        .WithMany("MainEmployees")
                        .HasForeignKey("IdMainDep")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TestProject1.EfContext.Department", "SecondaryDepartment")
            ...
            modelBuilder.Entity("TestProject1.EfContext.Sale", b =>
                {
                    b.HasOne("TestProject1.EfContext.Manager", "Manager")
                        .WithMany("Sales")
                        .HasForeignKey("ManagerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TestProject1.EfContext.Product", "Product")
                        .WithMany("Sales")
